# The Usefulness of Art – tools

Small, useful tools, built in the open.

[The Usefulness of Art](https://www.tuoa.com.au) is an arts consultancy:
grant writing, mentoring, advocacy and community development. These tools come
from the same place. Someone describes a job that is slow, fiddly or risky to
do by hand, and something simple would help. Most of them started that way –
with a friend or a colleague, and a real problem.
...
- **A person decides.** The tools find, extract and draft. People confirm,
  edit and approve.
- **Free and open.** MIT licence. Use them, read the code, adapt them.
...
Things built to test an idea. They work, but they are not finished tools, and
